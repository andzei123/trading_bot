...
def main():
    ...
    if entries:
        ...
        # IMPORTANT: do NOT apply profile routing for range_only (it would cut PHASE_RANGE entries)
        # Also avoid double-filtering for long_only / short_only (handled later by mode filter)
        if args.mode == "combined":
            # keep ALL entries in combined mode (no profile routing here)
            pass
        else:
            # range_only / long_only / short_only -> do nothing here
            pass
